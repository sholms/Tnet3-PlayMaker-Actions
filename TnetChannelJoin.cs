...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class TnetChannelJoin : FsmStateAction
	{
		...
		{
			TNet.TNManager.JoinChannel(channelid.Value,null,persistent.Value,playerLimit.Value,null,leavecurrentchannel.Value);
			Finish();
		}
